...
Risk Score = (0.4 × Transaction Frequency) + (0.4 × Transaction Amount) + (0.2 × High-Risk Jurisdiction Indicator)
...
📁 customer-risk-scoring-excel ├── customer_risk_scoring.xlsx ├── README.md
